...
namespace ClienteJuegos
{
    class Cliente
    {
        public static ServicioJuegos.TipoDificultad menuDificultad()
        {
            ServicioJuegos.TipoDificultad dificultad = ServicioJuegos.TipoDificultad.VACIO;
            int pDifi;
            ...
            do
            {
                ...
                switch (pDifi)
                {
                    case 1:
                        {
                            dificultad = ServicioJuegos.TipoDificultad.MUY_FACIL;
                            break;
                        }
                    case 2:
                        {
                            dificultad = ServicioJuegos.TipoDificultad.FACIL;
                            break;
                        }
                    case 3:
                        {
                            dificultad = ServicioJuegos.TipoDificultad.MEDIA;
                            break;
                        }
                    case 4:
                        {
                            dificultad = ServicioJuegos.TipoDificultad.DIFICIL;
                            break;
                        }
                    case 5:
                        {
                            dificultad = ServicioJuegos.TipoDificultad.MUY_DIFICIL;
                            break;
                        }
                    default:
                        {
        ...
        public static void Menu(ServicioJuegos.Gestor_JuegosClient ServicioCliente)
        {
            ...
            {
                Console.Clear();
                String sudoActual2 = ServicioCliente.GetSudoku(codSudoActual);
                    ...
                    case 1:
                        {
                            do
                            {
                                ...
                                switch (opcionGestion)
                                {
                                    case 1:
                                        {
                                            ServicioJuegos.TipoDificultad dificultad = menuDificultad();
                                            codSudoActual = ServicioCliente.NuevoJuego(dificultad);
                                    ...
                                    case 2:
                                        {
                                            ...
                                            if (resultado != -1)
                                            {
                                                ...
                                                {
                                                    ServicioCliente.BorrarJuego(resultado);
                    ...
                    case 2:
                        {
                            ...
                            {
                                Console.Clear();
                                String sudoActual = ServicioCliente.GetSudoku(codSudoActual);
                                ...
                                if (ServicioCliente.NumeroHuecos(codSudoActual) == 0)
                                {
                                    Console.WriteLine("*** SUDOKU COMPLETO ***");
                                    if (ServicioCliente.Correcto(codSudoActual) == false)
                                    {
                                ...
                                switch (opcionJugar)
                                {
                                    case 1:
                                        ...
                                        else if (ServicioCliente.ObtenerValor(codSudoActual, f - 1, c - 1) != ' ')
                                        {
                                            Aviso = 3;
                                        }
                                        else
                                        {
                                            ServicioCliente.PonerValor(codSudoActual, f - 1, c - 1, v);
                                            if (ServicioCliente.ComprobarValor(codSudoActual, f - 1, c - 1, v) == false)
                                            {
                                                Aviso = 4;
                                            }
                                            else
                                    ...
                                    case 2:
                                        ...
                                        {
                                            ServicioCliente.PonerValor(codSudoActual, f - 1, c - 1, ' ');
                                    ...
                                    case 3:
                                        ...
                                        if (f < 1 || f > 9 || c < 1 || c > 9 || ServicioCliente.ObtenerValor(codSudoActual, f - 1, c - 1) != ' ')
                                        {
                                            Aviso = 2;
                                        }
                                        else
                                        {
                                            Ayuda = ServicioCliente.Ayuda(codSudoActual, f - 1, c - 1);
                                            Aviso = 6;
                                        }
                                        break;
                                    case 0:
        ...
        {
            Console.WriteLine("Cliente, he conseguido conexión el servidor de Juegos, comenzamos...");
            ServicioJuegos.Gestor_JuegosClient ServicioCliente = new ServicioJuegos.Gestor_JuegosClient();
            Menu(ServicioCliente);
        }
    }
}
